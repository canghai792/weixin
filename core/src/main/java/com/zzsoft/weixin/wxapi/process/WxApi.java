...
public class WxApi {
    ...
    public static Map<String, String> getWSJSPayPara(String openId, String appId, String appsecret, String partnerkey,
        ...
        String strCurrentTime = com.zzsoft.weixin.core.util.wx.TenpayUtil2.getWXTime(currentTime);
        long currentTimeLay30m = currentTime + 30 * 60 * 1000;// 30分钟后 【要求至少5分钟过期】
        String strCurrentTimeLay30m = com.zzsoft.weixin.core.util.wx.TenpayUtil2.getWXTime(currentTimeLay30m);
        // 订 单 生 成 时 间 非必输
        ...
        com.zzsoft.weixin.core.util.wx.RequestHandler reqHandler = new com.zzsoft.weixin.core.util.wx.RequestHandler(null, null);
        ...
        try {
            ...
            if (null != retXmlStr && retXmlStr.contains("return_code")) {
                Map map = com.zzsoft.weixin.core.util.wx.TenpayUtil2.doXMLParseByDom4j(retXmlStr);
                ...
                com.zzsoft.weixin.core.util.wx.RequestHandler reqHandler_paySign = new com.zzsoft.weixin.core.util.wx.RequestHandler(null,
                        null);
