...
import com.zzsoft.weixin.core.spring.JsonView;
...
import com.zzsoft.weixin.wxapi.process.ErrCode;
...
import com.zzsoft.weixin.wxapi.process.MsgXmlUtil;
...
import com.zzsoft.weixin.wxapi.process.WxSign;
...
public class WxApiCtrl extends BaseCtrl{
    ...
    @ResponseBody
    public AjaxResult sendTemplateMessage(String openIds, String tplId, String content) throws WxErrorException  {
        MpAccount mpAccount = WxMemoryCacheClient.getMpAccount();//获取缓存中的唯一账号
        ...
        for (String openId : openIdArray) {
            ...
            dataMap.put("month", DateUtil.getDateToStr(new Date()));
            dataMap.put("day", DateUtil.getDateToStr(new Date()));
            dataMap.put("cardinfo", "33333");
            dataMap.put("transdate", DateUtil.changeDateTOStr(new Date()));
            dataMap.put("transtype", "转出");
            dataMap.put("money", "0.01");
